...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AppComponent = /** @class */ (function () {
                function AppComponent(afAuth, appService) {
                    var _this = this;
                    this.afAuth = afAuth;
                    ...
                    this.appService.progressBarStatus.subscribe(function (status) {
                        _this.progressBarLoading = status;
                    });
                }
                AppComponent.prototype.login = function () {
                    return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4 /*yield*/, this.afAuth.auth.signInWithRedirect(new firebase_app__WEBPACK_IMPORTED_MODULE_3__["auth"].GoogleAuthProvider())];
                                case 1:
                                    _a.sent();
                                    return [2 /*return*/];
                            }
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AppService = /** @class */ (function () {
                ...
                AppService.prototype.setProgressBarStatus = function (status) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var HomeComponent = /** @class */ (function () {
                function HomeComponent(afAuth, snackBar, dialog) {
                    this.afAuth = afAuth;
                ...
                HomeComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.subs.push(Object(rxjs__WEBPACK_IMPORTED_MODULE_6__["timer"])(0, 3000).subscribe(function () { return _this.getTopics(); }));
                };
                ...
                HomeComponent.prototype.getTopics = function () {
                    return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
                        var res, _a, e_2;
                        return __generator(this, function (_b) {
                            switch (_b.label) {
                                case 0:
                                    ...
                                    return [4 /*yield*/, fetch("http://localhost:3000/GetTopics")];
                                case 1:
                                    res = _b.sent();
                                    _a = this;
                ...
                HomeComponent.prototype.openNewTopicDialog = function () {
                    return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
                        return __generator(this, function (_a) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ReplyDialogComponent = /** @class */ (function () {
                function ReplyDialogComponent(dialogRef, afAuth, appService, data) {
                ...
                Object.defineProperty(ReplyDialogComponent.prototype, "message", {
                    get: function () {
                ...
                ReplyDialogComponent.prototype.addReply = function () {
                    return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
                        var uid;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                ...
                                case 1:
                                    ...
                                    return [4 /*yield*/, fetch(_app_service__WEBPACK_IMPORTED_MODULE_5__["AppService"].API + "/CreateReply", {
                                            method: "POST",
                ...
                return ReplyDialogComponent;
            }());
            ReplyDialogComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var TopicDialogComponent = /** @class */ (function () {
                function TopicDialogComponent(dialogRef, afAuth, appService) {
                    this.dialogRef = dialogRef;
                    this.afAuth = afAuth;
                    this.appService = appService;
                ...
                Object.defineProperty(TopicDialogComponent.prototype, "title", {
                    get: function () {
                ...
                Object.defineProperty(TopicDialogComponent.prototype, "message", {
                    get: function () {
                ...
                TopicDialogComponent.prototype.add = function (event) {
                ...
                TopicDialogComponent.prototype.remove = function (tag) {
                    var index = this.tags.indexOf(tag);
                    if (index >= 0) {
                        this.tags.splice(index, 1);
                    }
                };
                TopicDialogComponent.prototype.createNewTopic = function () {
                    return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
                        var uid;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                ...
                                case 1:
                                    _a.trys.push([1, , 3, 4]);
                                    uid = this.afAuth.auth.currentUser.uid;
                                    return [4 /*yield*/, fetch(_app_service__WEBPACK_IMPORTED_MODULE_6__["AppService"].API + "/CreateTopic", {
                                            method: "POST",
                                            headers: { "Content-Type": "application/json" },
                                            body: JSON.stringify({
                                                author: uid,
            ...
            TopicDialogComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var TopicComponent = /** @class */ (function () {
                function TopicComponent(afAuth, appService, router, route, snackBar, dialog) {
                    var _this = this;
                    this.afAuth = afAuth;
                    this.appService = appService;
                    this.router = router;
                    ...
                    this.subscriptions = [];
                    this.subscriptions.push(this.router.events.subscribe(function (event) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    if (!(event instanceof _angular_router__WEBPACK_IMPORTED_MODULE_2__["NavigationEnd"])) return [3 /*break*/, 2];
                                    return [4 /*yield*/, this.loadPostDetails()];
                                case 1:
                                    _a.sent();
                                    _a.label = 2;
                ...
                TopicComponent.prototype.loadPostDetails = function () {
                    return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
                        var topicID, res, _a, error_1;
                        var _this = this;
                        return __generator(this, function (_b) {
                            switch (_b.label) {
                                case 0:
                                ...
                                case 1:
                                    _b.trys.push([1, 4, , 5]);
                                    return [4 /*yield*/, fetch(_app_service__WEBPACK_IMPORTED_MODULE_8__["AppService"].API + "/GetTopic?topic=" + topicID)];
                                case 2:
                                    res = _b.sent();
                                    _a = this;
                                    return [4 /*yield*/, res.json()];
                                ...
                                case 4:
                                    ...
                                    return [3 /*break*/, 5];
                                case 5:
                                    this.subscriptions.push(Object(rxjs__WEBPACK_IMPORTED_MODULE_6__["timer"])(0, 3000).subscribe(function () { return _this.loadReplies(); }));
                                    return [2 /*return*/];
                            }
                        });
                    });
                };
                TopicComponent.prototype.loadReplies = function () {
                    return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
                        var res, replies_1, error_2;
                        var _this = this;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    _a.trys.push([0, 3, 4, 5]);
                                    return [4 /*yield*/, fetch(_app_service__WEBPACK_IMPORTED_MODULE_8__["AppService"].API + "/GetReplies?topic=" + this.topic.topicID)];
                                case 1:
                                    res = _a.sent();
                                    return [4 /*yield*/, res.json()];
                                case 2:
                                    replies_1 = _a.sent();
                                    replies_1.map(function (reply, i) {
                                        var liked = _this.isLikingReply(reply.likers);
                                        replies_1[i] = Object.assign({}, reply, { liked: liked });
                                    });
                                    this.replies = replies_1;
                                    return [3 /*break*/, 5];
                                case 3:
                                    error_2 = _a.sent();
                ...
                TopicComponent.prototype.isLikingReply = function (likers) {
                    if (!this.afAuth.auth.currentUser) {
                        return false;
                    }
                ...
                TopicComponent.prototype.likeReply = function (replyID) {
                    return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
                        var uid, i;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                ...
                                case 1:
                                    _a.trys.push([1, , 3, 4]);
                                    uid = this.afAuth.auth.currentUser.uid;
                                    return [4 /*yield*/, fetch(_app_service__WEBPACK_IMPORTED_MODULE_8__["AppService"].API + "/LikeReply?uid=" + uid + "&replyID=" + replyID)];
                                case 2:
                                    _a.sent();
                                    i = this.replies.length;
                                    while (i--) {
                ...
                TopicComponent.prototype.unlikeReply = function (replyID) {
                    return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
                        var uid_1, i;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                ...
                                case 1:
                                    _a.trys.push([1, , 3, 4]);
                                    uid_1 = this.afAuth.auth.currentUser.uid;
                                    return [4 /*yield*/, fetch(_app_service__WEBPACK_IMPORTED_MODULE_8__["AppService"].API + "/UnlikeReply?uid=" + uid_1 + "&replyID=" + replyID)];
                                case 2:
                                    _a.sent();
                                    i = this.replies.length;
                                    while (i--) {
                                        if (this.replies[i]["replyID"] == replyID) {
                                            this.replies[i].likes--;
                                            this.replies[i].likers = this.replies[i].likers.filter(function (e) { return e !== uid_1; });
                                        }
                                    }
                                    return [3 /*break*/, 4];
                                case 3:
                ...
                TopicComponent.prototype.openDialog = function () {
                    return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            if (!this.afAuth.auth.currentUser) {
                                this.snackBar.open("Please login first", "OK");
                ...
                TopicComponent.prototype.deleteReply = function (replyID) {
                    return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
                        var i;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                ...
                                case 1:
                                    _a.trys.push([1, , 3, 4]);
                                    return [4 /*yield*/, fetch(_app_service__WEBPACK_IMPORTED_MODULE_8__["AppService"].API + "/DeleteReply?replyID=" + replyID + "&topicID=" + this.topic.topicID)];
                                case 2:
                                    _a.sent();
                                    i = this.replies.length;
                                    while (i--) {
